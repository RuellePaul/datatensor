...
class APIError(HTTPException):
    def __init__(self, status_code, router=None, detail=None, data=None):
        super().__init__(status_code,
                         detail=detail or 'Something went wrong')
        self.router = router or 'Unknown'
        self.data = data


class BadRequest(APIError):
    def __init__(self, router=None, detail=None, data=None):
        super().__init__(400,
                         router=router,
