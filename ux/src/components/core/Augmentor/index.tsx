                            ...
                            <Grid container columnSpacing={4} rowSpacing={1}>
                                {activeStep === 0 && (
                                    <Grid item sm={7} xs={12}>
                                        ...
                                        <Typography variant="body1" gutterBottom>
                                            ...
                                            <strong>generate new images</strong> in order to get a richer dataset,
                                            without having to re-label anything.
                                        </Typography>

                                        <Typography variant="body2" gutterBottom color="textSecondary">
                                            To get augmented images of each original labeled image in your dataset, you
                                            need to set up a pipeline of operations to apply.{' '}
                                            <Link
                                                variant="caption"
                                                color="primary"
                                ...
                                {activeStep === 1 && (
                                    <Grid item sm={7} xs={12}>
                                        ...
                                        <Typography variant="body2" gutterBottom>
                                            A sample is the result of your operations pipeline applied to one image of
                                            your dataset.
                                        </Typography>
                                ...
                                {activeStep === 2 && (
                                    <Grid item sm={7} xs={12}>
                                        ...
                                        <Typography variant="body2" gutterBottom>
                                            Indicate the number of augmented images you want.
                                        </Typography>
                                        ...
                                        <Box mt={2} mb={3}>
                                            <Alert severity="info">
                                                ...
                                                <strong>{dataset.image_count * 4} augmented images</strong>.
                                            </Alert>
                                        </Box>
